package com.xyxy.cax.auth.util.aop;
...
import com.xyxy.kst.cax.remote.savelog.RemoteSaveLog;
...
public class OperLogAspect {
    ...
    @Autowired
    private RemoteSaveLog remoteSaveLog;
    @Autowired
    private RemoteUserService remoteUserService;

    @Pointcut("@annotation(com.xyxy.cax.auth.util.annotation.OperLog)")
    ...
    public void saveOperlog(JoinPoint joinPoint, Object keys){
        ...
        remoteSaveLog.saveUserEventLog(userEventLog);
    }
}
